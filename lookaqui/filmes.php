...
<body>
	<div class="container">
		<div class="hero">
			...
			<div>
    			<div class="row">
        			<table id="tabela" style="border-collapse: collapse; border: 1px solid lightgreen; border-spacing: 25; margin: auto; transform: translate(0%,0%); text-align: center;">
	...
	<script type="text/javascript" async>
    	...
    	const listaFilmes = async (nome) => {
        	const tabela = await fetch("api/filmes.php");
